...
SENSORS += (
    ...
    SwitchRWSensor(274, "Prog1 sell", bitmask=0x40, on=0x40),
    SwitchRWSensor(275, "Prog2 sell", bitmask=0x40, on=0x40),
    SwitchRWSensor(276, "Prog3 sell", bitmask=0x40, on=0x40),
    SwitchRWSensor(277, "Prog4 sell", bitmask=0x40, on=0x40),
    SwitchRWSensor(278, "Prog5 sell", bitmask=0x40, on=0x40),
    SwitchRWSensor(279, "Prog6 sell", bitmask=0x40, on=0x40),
)
SENSORS += (
    NumberRWSensor(
