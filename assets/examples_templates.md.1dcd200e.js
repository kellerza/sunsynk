import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.dfcac6be.js";const u=JSON.parse('{"title":"Home Assistant Templates","description":"","frontmatter":{},"headers":[],"relativePath":"examples/templates.md","filePath":"examples/templates.md","lastUpdated":1704222785000}'),p={name:"examples/templates.md"},e=l(`<h1 id="home-assistant-templates" tabindex="-1">Home Assistant Templates <a class="header-anchor" href="#home-assistant-templates" aria-label="Permalink to &quot;Home Assistant Templates&quot;">​</a></h1><p>You can view sensor values under Home Assistant using the &quot;Developer Tools&quot; -&gt; Templates tab.</p><details class="details custom-block"><summary>Example template</summary><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#85E89D;">Essentials</span><span style="color:#E1E4E8;">:     {{ </span><span style="color:#9ECBFF;">states(&quot;sensor.ss_essential_power&quot;)</span><span style="color:#E1E4E8;"> }} </span><span style="color:#9ECBFF;">W</span></span>
