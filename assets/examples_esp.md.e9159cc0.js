import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.dfcac6be.js";const h=JSON.parse('{"title":"ESP integration","description":"","frontmatter":{},"headers":[],"relativePath":"examples/esp.md","filePath":"examples/esp.md","lastUpdated":1704222785000}'),t={name:"examples/esp.md"},l=e(`<h1 id="esp-integration" tabindex="-1">ESP integration <a class="header-anchor" href="#esp-integration" aria-label="Permalink to &quot;ESP integration&quot;">​</a></h1><p>The ESP integration uses a combination of mysensors + Frontend</p><p>Init your ESP sensor with the following <strong>mysensors.py</strong> entry</p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">try</span><span style="color:#E1E4E8;">:</span></span>
