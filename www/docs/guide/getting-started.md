...
2. Install the "Sunsynk/Deye Inverter Add-on **(multi)**" from the **Add-On Store** and configure it
   through the UI.
...
The recommended version of the add-on. It supports multiple inverters and custom sensors. The
documentation available on this website is for the multi add-on version.
...
The [ESP add-on](./esp) allows you to query loadshedding schedules for your area from the
EskomSePush API.
