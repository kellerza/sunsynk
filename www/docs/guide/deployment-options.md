...
If the RJ-45 connector on the inverter side is crimped according to [T568B](https://en.wikipedia.org/wiki/ANSI/TIA-568#Wiring), you can use the pinout in the following table.

| RJ45 Pin<br>(inverter side) | Wire Color<br>(when using T568B) | RS485<br>pins |
| :-------------------------: | :------------------------------: | :-----------: |
|              1              |           Orange-White           |     B/D-      |
|              2              |              Orange              |     A/D+      |
|              3              |           Green-White            |      GND      |
